...
const sampleDataPoints: { position: [number, number]; type: string; title: string; value: string; color: string; }[] = [
  {
    position: [20.5, -10.5] as [number, number],
    type: "Healthcare",
  ...
  {
    position: [21.2, -11.3] as [number, number],
    type: "Education",
    title: "University",
  ...
  {
    position: [21.5, -10.2] as [number, number],
    type: "Infrastructure",
    title: "Power Plant",
    value: "50MW Capacity",
    color: "#ffaa44",
